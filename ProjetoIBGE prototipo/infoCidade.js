            ...
            $("#btnConsultar").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(escolarTotal){
                        var escolarizacaoTotal = "Alfabetização total de pessoas com 10 anos: ";
            ...
            $("#btnConsultar").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(escolarTotalH){
                        var escolarizacaoTotalH = "Alfabetização total de homens com 10 anos: "
            ...
            $("#btnConsultar").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(escolarTotalM){
                        var escolarizacaoTotalM = "Alfabetização total de mulheres com 10 anos: "
