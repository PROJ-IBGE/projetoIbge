$(document).ready(function(){
    ...
    // Conexão com a api de municípios acessada por estados
    ...
    // Conexão com a api de municípios
    $.ajax({
        ...
        success: function(cidades){
            var i;
            var cidade = "";
            cidade = cidade+"<option value=''>Selecione uma cidade</option>";
